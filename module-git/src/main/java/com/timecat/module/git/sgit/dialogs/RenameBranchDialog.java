...
public class RenameBranchDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(getString(R.string.git_dialog_rename_branch_title));
        View view = mActivity.getLayoutInflater().inflate(
                R.layout.git_dialog_rename_branch, null);
    ...
    public void onClick(View view) {
        ...
        if (newBranchname.equals("")) {
            Toast.makeText(mActivity, getString(R.string.git_alert_new_branchname_required),
                    Toast.LENGTH_LONG).show();
            mNewBranchname
                    .setError(getString(R.string.git_alert_new_branchname_required));
            return;
        }
