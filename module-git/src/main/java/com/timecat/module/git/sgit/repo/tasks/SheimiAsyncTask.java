package com.timecat.module.git.sgit.repo.tasks;
...
public abstract class SheimiAsyncTask<A, B, C> extends AsyncTask<A, B, C> {
     ...
     * {@link com.timecat.module.git.dialogs.ExceptionDialog} title when the
     * task fails with an exception.
     */
    @StringRes
    public int getErrorTitleRes() {
        return R.string.git_dialog_error_title;
    }
