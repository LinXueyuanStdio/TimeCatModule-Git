...
import com.timecat.module.git.sgit.repo.tasks.repo.CommitChangesTask;
...
public class CommitAction extends RepoAction {
    ...
    private void commit() {
        ...
        View layout = inflater.inflate(R.layout.git_dialog_commit, null);
        ...
        final AlertDialog d = builder.setTitle(R.string.git_dialog_commit_title)
                .setView(layout)
                                ...
                                public void onShow(DialogInterface dialog) {
                                    ...
                                    b.setOnClickListener(new View.OnClickListener() {
                                                             ...
                                                             public void onClick(View view) {
                                                                 ...
                                                                 int ltidx;
                                                                 if (msg.trim().equals("")) {
                                                                     commitMsg.setError(mActivity.getString(R.string.git_error_no_commit_msg));
                                                                     return;
                                                                 }
                                                                 if (!author.equals("")) {
                                                                     ltidx = author.indexOf('<');
                                                                     if (!author.endsWith(">") || ltidx == -1) {
                                                                         commitAuthor.setError(mActivity.getString(R.string.git_error_invalid_author));
                                                                         return;
                                                                     }
