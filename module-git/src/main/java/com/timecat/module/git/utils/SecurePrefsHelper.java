...
public class SecurePrefsHelper {
    ...
    private volatile static SecurePrefsHelper instance = null;

    private SecurePrefsHelper() {
    }

    public static SecurePrefsHelper getInstance() {
        if (instance == null) {
            synchronized (SecurePrefsHelper.class) {
                if (instance == null) {
                    try {
                        instance = new SecurePrefsHelper(BaseApplication.getContext());
    ...
    public SecurePrefsHelper(Context context) throws SecurePrefsException {
        ...
        try {
            ...
            LogUtil.w("pref password " + prefsPassword);
