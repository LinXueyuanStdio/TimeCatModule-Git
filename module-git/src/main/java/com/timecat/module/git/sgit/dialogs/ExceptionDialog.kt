...
class ExceptionDialog : SheimiDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setNegativeButton(getString(R.string.git_label_cancel), DummyDialogListener())
        builder.setPositiveButton(getString(R.string.git_dialog_error_send_report), DummyDialogListener())
