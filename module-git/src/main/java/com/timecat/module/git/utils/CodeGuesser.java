...
public class CodeGuesser {
    ...
    private final static String[][] FILENAME_EXTENSION_ARRAY = {
            ...
            {"Lisp", "text/x-common-lisp", "lisp", "lsp", "el", "cl", "jl", "L", "emacs", "sawfishrc"},
            {"CSS", "text/css", "css"},
            ...
            {"TeX", "text/x-stex", "cls", "latex", "tex", "sty", "dtx", "ltx", "bbl"},
    ...
    static {
        for (String[] extensions : FILENAME_EXTENSION_ARRAY) {
