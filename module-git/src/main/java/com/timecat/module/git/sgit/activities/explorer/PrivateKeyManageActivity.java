...
public class PrivateKeyManageActivity extends FileExplorerActivity implements ActionMode.Callback {
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        inflater.inflate(R.menu.git_action_mode_ssh_key, menu);
        return true;
    }
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        ...
        if (i == R.id.action_mode_rename_key) {
            ...
            return true;
        } else if (i == R.id.action_mode_show_private_key) {
            ...
            return true;
        } else if (i == R.id.action_mode_show_public_key) {
            Intent intent = new Intent(PrivateKeyManageActivity.this, ViewFileActivity.class);
            intent.putExtra(ViewFileActivity.TAG_FILE_NAME,
            ...
            startActivity(intent);
            return true;
        } else if (i == R.id.action_mode_edit_key_password) {
            Bundle pathArg;
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2) {
                new AlertDialog.Builder(this)
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setTitle(R.string.git_dialog_not_supported)
                        .setMessage(R.string.git_dialog_not_supported_msg)
                        .setPositiveButton(R.string.git_label_ok, null)
                        .show();
            } else {
                pathArg = new Bundle();
            ...
            new AlertDialog.Builder(this)
                    .setIcon(android.R.drawable.ic_dialog_alert)
                    .setTitle(R.string.git_dialog_key_delete)
                    .setMessage(getString(R.string.git_dialog_key_delete_msg) + " " + mChosenFile)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.git_private_key_manage, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.action_import) {
            ...
            return true;
        } else if (i == R.id.action_generate) {
