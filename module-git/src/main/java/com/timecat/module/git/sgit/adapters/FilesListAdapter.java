...
public class FilesListAdapter extends ArrayAdapter<File> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.git_listitem_files, parent,
                    false);
        ...
        if (item.isDirectory()) {
            holder.fileIcon.setImageResource(R.drawable.ic_folder_special_24dp);
        } else {
            holder.fileIcon.setImageResource(R.drawable.ic_file_special_24dp);
        }
        // set if selected
